            ...
            <div class="book-admin-field-row">
              <div style="flex:1 1 100%;">
                ...
                <div class="foundations-format-toolbar">
                  ...
                  <button type="button" class="foundations-format-btn" title="Insert Image" onclick="applyTWCourseAdminFormat(${idx}, 'image')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg></button>
                  <button type="button" class="foundations-format-btn" title="Insert Image Gallery (2+ images with prev/next arrows)" onclick="applyTWCourseAdminFormat(${idx}, 'gallery')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="14" height="14" rx="2"></rect><rect x="8" y="7" width="14" height="14" rx="2"></rect></svg></button>
